...
export function createWhatsApp() {
    // Jangan buat tombol dobel jika halaman sudah punya sticky WA sendiri
    if (document.querySelector('.wa-sticky, #whatsapp-float')) return;
