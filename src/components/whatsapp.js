...
export function createWhatsApp() {
    ...
    waLink.rel = 'noopener';
    waLink.setAttribute('aria-label', 'Free consultation via WhatsApp');

    const message = `Hi Atelier Nusa! I'm interested in a free consultation for a design/build project in Lombok. Could you help?`;
