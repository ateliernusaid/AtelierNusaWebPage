    ...
    build: {
        rollupOptions: {
            input: {
                ...
                architectLombok: resolve(__dirname, 'architect-lombok.html'),
                lombokVillaArchitect: resolve(__dirname, 'lombok-villa-architect.html'),
                architectMataram: resolve(__dirname, 'architect-mataram.html'),
                villaDesignerLombok: resolve(__dirname, 'villa-designer-lombok.html'),
                architectKutaMandalika: resolve(__dirname, 'architect-kuta-mandalika.html'),
                ...
                arsitekVillaSenggigi: resolve(__dirname, 'arsitek-villa-senggigi.html'),
                arsitekSelongBelanak: resolve(__dirname, 'arsitek-selong-belanak.html'),
                arsitekGiliTrawangan: resolve(__dirname, 'arsitek-gili-trawangan.html'),
                arsitekRumah2LantaiMataram: resolve(__dirname, 'arsitek-rumah-2-lantai-mataram.html'),
                arsitekHotelLombok: resolve(__dirname, 'arsitek-hotel-lombok.html'),
                arsitekBangunRumahLombok: resolve(__dirname, 'arsitek-bangun-rumah-lombok.html'),
            },
        },
    },
    server: {
